        ...
        <tr>
          ...
          <td style="padding-left: 15px; width: 296px; vertical-align: top;"><table width="100%">
			  ...
			  <tr>
                ...
                <td><?php if ($average) { ?>
                  <img src="catalog/view/theme/gimboo/image/stars_<?php echo $average . '.png'; ?>" alt="<?php echo $text_stars; ?>" style="margin-top: 2px;" />
                  <?php } else { ?>
      ...
      <table class="list">
        ...
        <tr>
          ...
          <td width="25%"><?php if (isset($products[$j])) { ?>
            ...
            <img src="catalog/view/theme/gimboo/image/stars_<?php echo $products[$j]['rating'] . '.png'; ?>" alt="<?php echo $products[$j]['stars']; ?>" />
            <?php } ?>
            <?php } ?></td>
          <?php } ?>
        </tr>
...
function review() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#review_title').after('<div class="wait"><img src="catalog/view/theme/gimboo/image/loading_1.gif" alt="" /> <?php echo $text_wait; ?></div>');
		},
		complete: function() {
