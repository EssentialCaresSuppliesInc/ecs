<div class="box">
  <div class="top"><img src="catalog/view/theme/gimboo/image/latest.png" alt="" /><?php echo $heading_title; ?></div>
  <div class="middle">
    <?php if ($products) { ?>
    <table cellpadding="2" cellspacing="0" style="width: 100%;">
      ...
      <tr>
        ...
        <td valign="top"><a href="<?php echo str_replace('&', '&amp;', $product['href']); ?>"><?php echo $product['name']; ?></a>
          ...
          <br />
          <img src="catalog/view/theme/gimboo/image/stars_<?php echo $product['rating'] . '.png'; ?>" alt="<?php echo $product['stars']; ?>" />
          <?php } ?></td>
      </tr>
      <?php } ?>
    </table>
